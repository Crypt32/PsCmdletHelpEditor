...
public interface IUIMessenger {
    ...
    /// <param name="fileType">Optional file types.</param>
    ...
    ///     </list>
    /// </returns>
    Boolean TryGetSaveFileName(out String? filePath, String? fileType = null, String? suggestedFileName = null, String? defaultExtension = null);
    /// <summary>
    ...
    ///     </list>
    /// </returns>
    Boolean TryGetOpenFileName(out String? filePath, String? fileType = null, String? suggestedFileName = null, String? defaultExtension = null);
    /// <summary>
    /// Shows "Browse folder" dialog to select a path to a folder.
    /// </summary>
    /// <param name="folderPath">Full path to a folder if method returns <c>true</c>.</param>
    /// <returns>
    ///     <list type="bullet">
    ///         <item><c>true</c> - folder location is selected. In this case <strong>folderPath</strong> parameter is populated.</item>
    ///         <item><c>false</c> - folder location selection aborted or declined.</item>
    ///     </list>
    /// </returns>
    Boolean TryGetBrowseFolderDialog(out String? folderPath);
}